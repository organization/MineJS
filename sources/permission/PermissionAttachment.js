...
module.exports = {
    onLoad : ()=>{
        minejs.permission.PermissionAttachment = class PermissionAttachment{
            /**
             ...
             */
            setRemovalCallback(executor){ this._removed = executor; }
            
            /**
             * @return {minejs.permission.PermissionRemovedExecutor}
             */
            getRemovalCallback(){ return this._removed; }
            ...
            remove(){ this._permissible.removeAttachment(this); }
        }
    }
}