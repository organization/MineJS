...
module.exports = {
    onLoad : ()=>{
        minejs.permission.Permission = class Permission{
            ...
            static get DEFAULT_PERMISSION() { return Permission.DEFAULT_PERMISSION; }
             ...
             */
            getPermissibles(){ return minejs.Server.getInstance().getPluginManager().getPermissionSubscriptions(this.name); }
